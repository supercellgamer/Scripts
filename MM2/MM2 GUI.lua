-- GUI created by ClientZero
-- Scripts created from other peeps
-- YouTube Video: https://youtu.be/k6GpIU_-evI
...
emotes.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://pastebin.com/raw/xcjzjzr8", true))()
end)
